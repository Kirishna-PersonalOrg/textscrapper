...
public class RegexTextFormatter {
    ...
    public static void main(String[] args) {
        ...
        for (String passage : passageList) {
            ...
            try (BufferedWriter writer = new BufferedWriter(new FileWriter(filePath + fileCounter + ".txt"))) {
                List<String> formattedList = formatter(passage);
    ...
    private static List<String> formatter(String text) {
